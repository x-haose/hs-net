...
> 源码: [https://github.com/x-haose/hs-net/blob/main/examples/proxy/fixed_proxy.py](https://github.com/x-haose/hs-net/blob/main/examples/proxy/fixed_proxy.py)

```python title="fixed_proxy.py"
"""
固定代理
