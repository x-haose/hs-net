...
> 源码: [https://github.com/x-haose/hs-net/blob/main/examples/proxy/switch_proxy.py](https://github.com/x-haose/hs-net/blob/main/examples/proxy/switch_proxy.py)

```python title="switch_proxy.py"
"""
代理切换
