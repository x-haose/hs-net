...
> 源码: [https://github.com/x-haose/hs-net/blob/main/examples/real_world/scraping.py](https://github.com/x-haose/hs-net/blob/main/examples/real_world/scraping.py)

```python title="scraping.py"
"""
网页内容抓取
