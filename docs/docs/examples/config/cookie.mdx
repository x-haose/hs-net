...
> 源码: [https://github.com/x-haose/hs-net/blob/main/examples/config/cookie.py](https://github.com/x-haose/hs-net/blob/main/examples/config/cookie.py)

```python title="cookie.py"
"""
Cookie 管理
