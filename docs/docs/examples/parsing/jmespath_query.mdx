...
> 源码: [https://github.com/x-haose/hs-net/blob/main/examples/parsing/jmespath_query.py](https://github.com/x-haose/hs-net/blob/main/examples/parsing/jmespath_query.py)

```python title="jmespath_query.py"
"""
JMESPath JSON 查询
