...
| 章节 | 说明 | 示例文件 |
|------|------|----------|
| [CSS 选择器](#css-选择器) | CSS 语法提取 HTML | [`css_xpath.py`](https://github.com/x-haose/hs-net/blob/main/examples/parsing/css_xpath.py) |
| [XPath](#xpath) | XPath 语法提取 HTML | [`css_xpath.py`](https://github.com/x-haose/hs-net/blob/main/examples/parsing/css_xpath.py) |
| [正则表达式](#正则表达式) | 正则匹配提取 | [`css_xpath.py`](https://github.com/x-haose/hs-net/blob/main/examples/parsing/css_xpath.py) |
| [JMESPath](#jmespathjson-查询) | JSON 数据查询 | [`jmespath_query.py`](https://github.com/x-haose/hs-net/blob/main/examples/parsing/jmespath_query.py) |
| [URL 转换](#url-转换) | 相对 URL 转绝对 | — |
