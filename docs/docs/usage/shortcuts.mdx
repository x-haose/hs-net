...
| 章节 | 说明 | 示例文件 |
|------|------|----------|
| [基本用法](#基本用法) | 模块级快捷函数 | [`shortcuts.py`](https://github.com/x-haose/hs-net/blob/main/examples/basic/shortcuts.py) |
| [指定引擎](#指定引擎) | 快捷函数切换引擎 | [`shortcuts.py`](https://github.com/x-haose/hs-net/blob/main/examples/basic/shortcuts.py) |
| [可用函数](#可用函数) | 同步/异步函数列表 | — |
| [快捷函数 vs Net/SyncNet](#快捷函数-vs-netsyncnet) | 选型建议 | — |
