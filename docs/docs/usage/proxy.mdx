...
| [身份路由](#身份路由) | 按请求身份自动分配并绑定代理 | [`identity_routing.py`](https://github.com/x-haose/hs-net/blob/main/examples/proxy/identity_routing.py) |
...
```python title="identity_routing.py"
...
```python title="extractor_examples.py"
# 从 headers 提取
...
```python title="identity_with_rules.py"
svc = ProxyService(
...
完整示例见 [`examples/proxy/identity_routing.py`](https://github.com/x-haose/hs-net/blob/main/examples/proxy/identity_routing.py)。
