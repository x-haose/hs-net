...
| 章节 | 说明 | 示例文件 |
|------|------|----------|
| [GET](#get) | GET 请求 | [`http_methods.py`](https://github.com/x-haose/hs-net/blob/main/examples/basic/http_methods.py) |
| [POST](#post) | JSON / 表单 / 文件上传 | [`http_methods.py`](https://github.com/x-haose/hs-net/blob/main/examples/basic/http_methods.py) |
| [PUT / PATCH / DELETE](#put) | 其他 HTTP 方法 | [`http_methods.py`](https://github.com/x-haose/hs-net/blob/main/examples/basic/http_methods.py) |
| [通用 request 方法](#通用-request-方法) | 动态指定 HTTP 方法 | — |
