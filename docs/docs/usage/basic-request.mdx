...
| 章节 | 说明 | 示例文件 |
|------|------|----------|
| [异步请求](#异步请求) | async with Net 基本用法 | [`get.py`](https://github.com/x-haose/hs-net/blob/main/examples/basic/get.py) |
| [同步请求](#同步请求) | with SyncNet 基本用法 | [`get.py`](https://github.com/x-haose/hs-net/blob/main/examples/basic/get.py) |
| [Response 常用属性](#response-常用属性) | 响应对象的属性和方法 | — |
| [带参数的请求](#带参数的请求) | params、headers、UA 等 | — |
